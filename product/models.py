...
class Brand(models.Model):
    ...
    image = models.ImageField(verbose_name=_('image of brand'))
    ...
    logo = models.ImageField(verbose_name=_('logo of brand'), help_text=_('height and width 600 X 600 px'),
                             width_field=600, height_field=600)
    judiciary_brand_registration_form = models.ImageField()
...
class Product(models.Model):
    ...
    images = models.ImageField(verbose_name=_('images of product'))
